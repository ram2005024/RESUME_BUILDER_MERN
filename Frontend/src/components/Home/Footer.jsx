  ...
  return (
    <div>
      <>
        ...
        <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-pink-100">
          ...
          <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
            <p className="max-w-60">
              Making every customer feel valued—no matter the size of our
              audience.
            </p>
            <div className="flex items-center gap-4 mt-3">
              ...
              <a
                href="https://www.youtube.com/@cutie8864"
                target="_blank"
                rel="noreferrer"
              >
                <svg
            ...
            <p className="mt-3 text-center">© 2025 Cyrus Resume Builder</p>
          </div>
        </footer>
      </>
    </div>
